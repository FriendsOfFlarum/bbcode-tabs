...
app.initializers.add('fof/bbcode-tabs', function () {
  var id = 0;
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_components_CommentPost__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'oncreate', function () {
    var containers = this.$('.tabs');
    containers.each(function (i, container) {
      var $container = $(container);
      if ($container.find('input[type="radio"][name]').length) return;
      var $inputs = $container.find('> .tab > input[type="radio"]');
      if (!$inputs.length) return;
      var $items = $container.find('.tab');
      var num = id++;
