...
app.initializers.add('fof/bbcode-tabs', function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_components_CommentPost__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'config', function (original, isInitialized) {
    console.log('hey');
    if (isInitialized) return;
    var containers = this.$('.tab-container');
    containers.each(function (i, container) {
      var $container = $(container);
      var tabsItems = $container.find('.tab');
      ...
      tabs__WEBPACK_IMPORTED_MODULE_0___default()(container);
    });
  });
});
